...
# (for faster processing)
    imageA = cv2.imread('D:\\homework\\homework\\house\\11\\5-6.jpg')
    imageB = cv2.imread('D:\\homework\\homework\\house\\11\\6-1.jpg')
...
# show the images
    ...
    print('%.5f s' %(end-start))
    cv2.imwrite('D:\\homework\\homework\\house\\11\\img5.jpg', vis)
