...
if __name__ == '__main__':
    ratio=1
    image = cv2.imdecode(np.fromfile('C:\\Users\\admin\\Desktop\\result\\焊缝提取\\6\\XQⅡ-GH000+M001+2-02.jpg', dtype=np.uint8), 0)
    ...
    cv2.imwrite('D:\\testALg\\homework\\house\\227\\results1.jpg', np.uint8(thresh))
