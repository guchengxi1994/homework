...
def split_bd_pic(path,part_num):
	...
	# random.shuffle(all_picl)
	print('共筛选出{}个待组合图片!'.format(len(all_picl)))
	split_part = split_list(all_picl, part_num)
	return split_part

if __name__ == '__main__':
	fs_excel = [["sim_929_21bd_1.txt","sim_929_21bd_1.xls"],
				["sim_929_21bd_2.txt","sim_929_21bd_2.xls"],
				["sim_929_21bd_3.txt", "sim_929_21bd_3.xls"],
				["sim_929_21bd_4.txt", "sim_929_21bd_4.xls"],
				["sim_929_21bd_5.txt", "sim_929_21bd_5.xls"],
				["sim_929_21bd_6.txt", "sim_929_21bd_6.xls"],
				["sim_929_21bd_7.txt", "sim_929_21bd_7.xls"],
				["sim_929_21bd_8.txt", "sim_929_21bd_8.xls"],
				["sim_929_21bd_9.txt", "sim_929_21bd_9.xls"],
				["sim_929_21bd_10.txt", "sim_929_21bd_10.xls"]
				]
	...
	pic_list_all = split_bd_pic('/home/aijr/weld/D/21/',8)
