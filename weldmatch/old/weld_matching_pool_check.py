...
if __name__ == '__main__':
	fs = "sim_result_21bd_checks_107.txt"
	weld_path = '/home/aijr/weld/D/22/'
	with open('./save_feature_22bd/85666488f94fcb178b14639bad82ceaa.dump', 'rb') as fr:
	...
	for line in open(txt_path):
		...
		for linea in open(txt_pathx, encoding='utf8'):
			ss = str(linea).split('>>>>>>>>')
			gga = [ss[0], ss[1][:-1]]
	...
	with open(fs, "a") as f:
		...
		data.to_excel("sim_result_21bd_checks_107.xls")
		pool.close()
		pool.join()
		print(error_pic)
		print(len(error_pic))
