import torch
from tools.model import D2Net
from tools.utils import preprocess_image
from tools.pyramid import process_multiscale
import scipy
import scipy.io
import scipy.misc
import numpy as np
...
def feature_extract(image,scales=[.25, 0.50, 1.0], nfeatures = 1000):
