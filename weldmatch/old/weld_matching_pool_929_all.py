...
def match_rules(matchess,locations_1_to_use,locations_2_to_use):
	...
	if low_ju>=0.75 and diff_down<0.8 and diff_up<0.86:
		return 1,low_ju
	else:
		return 0,low_ju
...
if __name__ == '__main__':
	fs_excel = [["sim_1013_21bd_1all.txt","sim_1013_21bd_1all.xls"],
				["sim_1013_21bd_2allx.txt","sim_1013_21bd_2allx.xls"]]
