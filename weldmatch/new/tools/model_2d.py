...
def ResNet(inputs, blocks, block, include_top=True, classes=1000, freeze_bn=True, numerical_names=None, *args, **kwargs):
	...
	x = tools.layer_bn.BatchNormalization(axis=axis, epsilon=1e-5, freeze=freeze_bn, name="bn_conv1")(x)
...
def ResNet18(inputs, blocks=None, include_top=True, classes=1000, *args, **kwargs):
	...
	return ResNet(inputs, blocks, block=tools.block_2d.basic_2d, include_top=include_top, classes=classes, *args, **kwargs)
...
def ResNet50(inputs, blocks=None, include_top=True, classes=1000, *args, **kwargs):
	...
	return ResNet(inputs, blocks, numerical_names=numerical_names, block=tools.block_2d.bottleneck_2d, include_top=include_top, classes=classes, *args, **kwargs)
