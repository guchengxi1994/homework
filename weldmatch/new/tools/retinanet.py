...
'''
import keras
import tools.initializers as initializers
import tools.misc as layers
import tools.filter_detection as layers_f
...
def retinanet_bbox(
    ...
    **kwargs
    ...
    detections = layers_f.FilterDetections(nms=nms, name='filtered_detections')([boxes, classification] + other)
