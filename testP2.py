...
img_orig_gray = rgb2gray(io.imread('D:\\projectWelds\\AWelds\\XQⅡ-GD000-M001-W-01.jpg'))
checkerboard = img_as_float(img_orig_gray)
print(checkerboard.shape)
img_orig = np.zeros(list(checkerboard.shape) + [3]) #2D 转3D
...
img_warped_gray = rgb2gray(io.imread('D:\\projectWelds\\AWelds\\XQⅡ-GD000-M001-W-01.jpg'))
